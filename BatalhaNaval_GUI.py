...
class Tabuleiro:
    ...
    def atacar(self, i, j):
        ...
        return self.__matriz[i][j].getCheio()
    ...
    def atacar(self, tabuleiro_humano):
        ...
        while tentativas < 100:
            ...
            if tabuleiro_humano.verifica_status(i, j) == True:
                ...
                return i, j, tabuleiro_humano.atacar(i, j)
...
class Jogo():
    ...
    def init_tabuleiros(self):
        ...
        GUI_posicinar = Posicionar(
            self.__tabuleiro_humano, self.__navios_humano, self.andamento)
        GUI_posicinar.loop_principal()

    def andamento(self):
        GUI_combate = Combate(self.__tabuleiro_humano, self.__tabuleiro_IA,
                              self.__navios_humano, self.__navios_Ia, self.__ia, self.verifica_fim)
        GUI_combate.loop_principal()
